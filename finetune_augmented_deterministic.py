...
parser.add_argument("--featureExtract", type=str, help="Flag for feature extracting. When False, we finetune the whole model", default="true")
...
if args.featureExtract == "true":
    feature_extract = True
else:
    feature_extract = False

print("Feature extract: " + str(feature_extract))
...
def train_model(model, dataloaders, criterion, optimizer, num_epochs=25, is_inception=False, input_size=512, sigmoidThreshold=0.5, num_classes=11):
    ...
    for epoch in range(num_epochs):
        ...
        f=open("deeper_trainlog_augmented_"+timestamp+".txt", "a")
        ...
        for phase in ['train', 'val']:
            ...
            for concat_factor in cycle([1,4,9]):
...
if feature_extract:
    print("Only training upper layers")
