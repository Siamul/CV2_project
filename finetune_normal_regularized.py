...
parser.add_argument("--epochs", type=int, help="Number of epoch to train", default=20)
...
parser.add_argument("--inputSize", type=int, help="Size of input images", default=512)
parser.add_argument("--Dropout", type=int, help="Fraction of dropout", default=0.5)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(best_model_wts, "./normal_weights/model_"+str(best_acc)+".pt")
            if phase == 'val':
